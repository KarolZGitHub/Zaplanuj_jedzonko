                        ...
                        <c:forEach var="plan" items="${plan}">
                            <tr class="d-flex">
                                ...
                                <td class="col-2 d-flex align-items-center justify-content-center flex-wrap">
                                    ...
                                    <a href="<c:url value='/app/plan/planDetails.jsp?id=${plan.id}'/>" class="btn btn-info rounded-0 text-light m-1">Szczegóły</a>
                                    <a href="<c:url value='/app/plan/planEdit.jsp?id=${plan.id}'/>" class="btn btn-warning rounded-0 text-light m-1">Edytuj</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
